...
folders = {
    ...
    'clips': dataFolder  + "clips/",
    'movies': dataFolder  + "movies/",
    'target': dataFolder  + "targets/",
    'plot': dataFolder  + "trajectories/",
    'titles': dataFolder  + "titles/",
    'pages': dataFolder  + "pages/",
...
dbHighlights        = dbFolder + 'highlights.csv'
