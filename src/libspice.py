...
def loadKernels():
    ...
    # ck - camera pointing kernels
    # spice.furnsh('kernels/ck/vgr1_super.bc') # voyager 1 pointing data, continuous (11mb)
    spice.furnsh('kernels/ck/vg1_jup_version1_type1_iss_sedr.bc') # vg1 jup pointing, discrete (700k)
    ...
    # spk - spacecraft and planet position kernels
    ...
    # pck - planetary constant kernels
...
def getDistance(position):
    "get distance from a position vector"
    x,y,z = position
